...
class RegistrationController: UIViewController {
    ...
    private let alredayHaveAccountButton: UIButton = {
    ...
    @objc func handleRegistration() {
        ...
        Auth.auth().createUser(withEmail: email, password: password) { (result, error) in
            ...
            print("DEBUH: Succesfully registered user")
        }
    ...
    func configureUI() {
        ...
        view.addSubview(alredayHaveAccountButton)
        alredayHaveAccountButton.anchor(left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor,
